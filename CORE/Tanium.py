...
def plug_in():                                                   # 변수 명 Full Name : Full Name에서 대문자로 명시한 것들을 뽑아서 사용 (괄호 안의 내용은 설명)
    ...
    if STCU == 'true' :
        ...
        if STOPDBPU == 'true' :
            ...
            MSTD = OSGBS + OSVGBS + IVGBS + CTGBS + LPCGBS + EPCGBS + IAGBS + RSGBS + LRBGBS + DUSGBS + GRUGBS + GCUGBS + GLPCGBS + GEPCGBS + GRSCGBS + GRPLRGBS + GDUSGBS  # Minutely Statistics Total Data (minutely_statistics Table에 넣을 모든 통계데이터)
